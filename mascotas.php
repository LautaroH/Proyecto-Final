	...
	<body id="home">
			...
			<header>
				...
				<nav>
					<ul>
						...
						<li><a href="mascotas.html" id="homenav">Mascotas Perdidas</a></li>
      ...
      <div class="slider-wrapper theme-default">
        <div id="slider" class="nivoSlider">
          <img src="images/perdidos.jpg" alt="" />
        </div>
      </div>
        ...
        <div id="line">
          ...
          <article>
            ...
            <h1><a href="arrow.html"></a></h1>
            <a href="arrow.html"><img src="images/perdido5.jpg" alt="" /></a>
          ...
          <article class="lastarticle">
            ...
            <h1><a href="strangerthings.html"></a></h1>
            <a href="StrangerThings.html"><img src="images/perdido6.jpg" alt="" /></a>
